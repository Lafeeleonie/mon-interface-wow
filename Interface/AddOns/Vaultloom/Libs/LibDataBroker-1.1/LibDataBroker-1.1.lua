...
if oldminor < 4 then
    local nextEntry = pairs(attributestorage)
    function lib:pairs(dataobject_or_name)
        local valueType = type(dataobject_or_name)
        ...
        return nextEntry, attributestorage[dataobj], nil
    end

    local ipairsIter = ipairs(attributestorage)
    function lib:ipairs(dataobject_or_name)
        ...
        return ipairsIter, attributestorage[dataobj], 0
    end
end
